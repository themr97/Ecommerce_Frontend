  ...
  return (
    <Fragment>
      ...
      <div
        ...
        id="sidebar"
        className={show ? 'hidden md:block sticky top-0 left-0 h-screen md:w-3/12 lg:w-2/12 sidebarShadow bg-white text-gray-600' : 'md:block sticky top-0 left-0 h-screen md:w-3/12 lg:w-2/12 sidebarShadow bg-white text-gray-600'}
      >
        <div
